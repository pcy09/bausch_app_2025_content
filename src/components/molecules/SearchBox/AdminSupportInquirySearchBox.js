...
const AdminSupportInquirySearchBox = ({ onHandleSearchData, categoryOptions }) => {
    ...
    <CardContainer css={[marginBottomStyle(24)]}>
      <Form onSubmit={handleSubmit(onSubmit, onError)}>
        <FilterBox handleReset={handleResetSearch}>
          <DateSearchAtom title={'문의 등록일'} control={control} />
...
export default AdminSupportInquirySearchBox;
