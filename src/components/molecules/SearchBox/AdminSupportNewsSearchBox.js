...
const AdminSupportNewsSearchBox = ({ selectOptions, selectInputOptions, retiredProductOptions, onHandleSearchData }) => {
    ...
    <CardContainer css={[marginBottomStyle(24)]}>
      <Form onSubmit={handleSubmit(onSubmit, onError)}>
        <FilterBox handleReset={handleResetSearch}>
          ...
          <SelectAtom defaultValue="all" name="productInfo" control={control} title={'발행 여부'} options={selectOptions} />
        </FilterBox>
      </Form>
    </CardContainer>
  );
...
export default AdminSupportNewsSearchBox;
