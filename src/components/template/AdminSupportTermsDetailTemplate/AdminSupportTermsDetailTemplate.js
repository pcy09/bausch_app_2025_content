...
import { fileuploadLabel, marginLeftStyle, subLabel } from '@/styles/components/atomCommonStyle';
...
const AdminSupportTermsDetailTemplate = () => {
  ...
  return (
    <>
      <NoticeLabel title={'👉🏼 바슈롬 포인트, 바슈롬 앱, 렌즐리의 약관 및 정책 상세 페이지입니다.'} />
...
export default AdminSupportTermsDetailTemplate;
const col_style = css`
  display: flex;
  align-items: center;
